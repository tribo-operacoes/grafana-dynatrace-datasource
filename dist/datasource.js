...
System.register(['lodash'], function (_export, _context) {
  ...
  var _, _createClass, DynatraceDatasource;
  ...
  return {
    ...
    execute: function () {
        ...
        _createClass(DynatraceDatasource, [{
          ...
          value: function query(options) {
            ...
            return this.q.all(requests).then(function (results) {
              ...
              Object.keys(results).forEach(function (r) {
                ...
                metrics = metrics.concat(_.filter(m, function (serie) {
          ...
          value: function getEntities(target, dimension) {
            ...
            return this.doRequest(options).then(function (res) {
              var entities = _.pickBy(res.data.result.entities, function (key) {
                return _.startsWith(key, dimension);
              });

              return _.map(entities, function (d, i) {
          ...
          value: function metricFindDetails(query) {
            ...
            return this.doRequest({
              ...
              var entry = _.filter(res.data, function (item) {
      ...
      _export('default', DynatraceDatasource);
    }
  };
});
